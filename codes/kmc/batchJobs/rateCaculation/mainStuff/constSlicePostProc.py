...
with open(resultDir+"/"+dataLocation+"/flowMeans.dat", 'w') as f:
    for i in range(0, len(rateData)):
        f.write(str(rateData[i][0])+" "+str(rateData[i][7])+" "+str(flowMoments[i][2])+"\n")

with open(resultDir+"/"+dataLocation+"/flowVars.dat", 'w') as f:
    for i in range(0, len(rateData)):
        f.write(str(rateData[i][0])+" "+str(rateData[i][7])+" "+str(flowMoments[i][3])+"\n")

with open(resultDir+"/"+dataLocation+"/flowSkew.dat", 'w') as f:
    for i in range(0, len(rateData)):
        f.write(str(rateData[i][0])+" "+str(rateData[i][7])+" "+str(flowMoments[i][4])+"\n")

with open(resultDir+"/"+dataLocation+"/flowKurt.dat", 'w') as f:
    for i in range(0, len(rateData)):
        f.write(str(rateData[i][0])+" "+str(rateData[i][7])+" "+str(flowMoments[i][5])+"\n")
...
with open(resultDir+"/"+dataLocation+"/densErrs.dat", 'w') as f:
    for index in rateData:
        if index[3] != 0.0:
            f.write(str(index[0])+" "+str(rateData[i][7])+" "+str(100.0*index[4]/abs(index[3]))+"\n")
        else:
            f.write(str(index[0])+" "+str(rateData[i][7])+" "+str(-1.0)+"\n")
...
with open(resultDir+"/"+dataLocation+"/histErrs.dat", 'w') as f:
    for index in rateData:
        if index[5] != 0.0:
            f.write(str(index[0])+" "+str(rateData[i][7])+" "+str(100.0*index[6]/abs(index[5]))+"\n")
        else:
            f.write(str(index[0])+" "+str(rateData[i][7])+" "+str(-1.0)+"\n")
 
with open(resultDir+"/"+dataLocation+"/blockDev.dat", 'w') as f:
    for index in rateData:
        f.write(str(index[0])+" "+str(rateData[i][7])+" "+str(index[5] - 1.0/(1.0-index[3]/float(sysSize)))+"\n")
