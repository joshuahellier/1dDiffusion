...
Show[ListContourPlot[entData, InterpolationOrder->1, Contours->30, PlotRange->{All, {-3, 1},Automatic}, ColorFunction->"Rainbow", PlotLegends->Automatic, ImageSize->512], FrameLabel->{{"Log[\[Lambda]]", "Entropy"}, {"\[Rho]", None}}, RotateLabel->True, Frame->True]
Show[ListContourPlot[{#[[2]], Log10[#[[1]]], Log10[-#[[3]]]}&/@currData, InterpolationOrder->1, Contours->30, PlotRange->{All, {-3, 1},Automatic}, ColorFunction->"Rainbow", PlotLegends->Automatic, ImageSize->512], FrameLabel->{{"Log[\[Lambda]]", "Log[DiffCoeff]"}, {"\[Rho]", None}}, RotateLabel->True, Frame->True]
