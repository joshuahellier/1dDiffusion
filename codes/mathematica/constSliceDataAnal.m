...
ListContourPlot[flowMeans1, InterpolationOrder->0, ColorFunction->"Rainbow", PlotLegends->True, FrameLabel->{{"\[Delta]\[Rho]", "Flow Rate/\!\(\*SuperscriptBox[\(s\), \(-1\)]\)"}, {"\[Lambda]", None}}, RotateLabel->True, Frame->True, Contours->20]
